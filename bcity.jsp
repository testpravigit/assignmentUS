...
<option value="byname.jsp">first_name</option>
<option value="state.jsp">state</option>
</select> -->
<form action="byCity">
<input type="text" name="city" value="" placeholder="Enter the details">
...
<%
List<Customer> l=(List<Customer>)request.getAttribute("m");
